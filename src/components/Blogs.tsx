  ...
  const topBlogs = [
    {
      ...
      title: "title1",
      image: "/image 2.png",
      link: "https://www.clinicsanmiguel.com/blog/la-importancia-del-mamograma-de-rutina",
    },
    {
      date: "24 Oct, 2022",
      title: "title2",
      image: "/image 3.png",
      link: "https://www.clinicsanmiguel.com/blog/que-esperar-durante-un-examen-fsico-para-la-escuela",
    },
    {
      date: "24 Oct, 2022",
      title: "title3",
      image: "/image 4.png",
      link: "https://www.clinicsanmiguel.com/blog/why-you-shouldnt-skip-your-well-woman-exam ",
    },
  ];
    ...
    <div className="w-full flex justify-center min-h-[50vh] py-20 bg-[#F9F8F6]">
      <div className="w-[90%] max-w-[1500px] flex flex-col gap-5 justify-center items-center\">
        ...
        <div className="w-full flex-col md:flex-row items-center flex justify-between mt-6 gap-3 flex-wrap">
          {topBlogs.map((blog, index) => (
            <a href={blog.link}>
              <div
                key={index}
                className="w-[350px] cursor-pointer flex flex-col gap-4"
              >
                <img
                  src={blog.image}
        ...
        <button className="py-3 px-16 bg-none font-bold text-sm border border-[#D01717] text-[#D01717] rounded-lg self-center my-10">
          <a href={"https://www.clinicsanmiguel.com/blog"}> {t("viewAll")} </a>
        </button>
      </div>
    </div>
  );
